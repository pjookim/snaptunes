...
export default function Step1UnifiedCard(props: Props) {
  ...
  if (!selectedPlatform || !isAuthorizedForSelected) {
    return (
            ...
            <div className="grid grid-rows-1 grid-cols-1 md:grid-cols-3 gap-3">
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0">
                    <Image src="/spotify-logo.svg" alt="Spotify" width={48} height={48} />
                </div>
                <div className="text-left md:text-center">
                  <div className="text-lg font-semibold text-foreground">Spotify</div>
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0">
                    <Image src="/applemusic-logo.svg" alt="Apple Music" width={48} height={48} />
                </div>
                <div className="text-left md:text-center">
                  <div className="text-lg font-semibold text-foreground">Apple Music</div>
                  <div className="text-xs text-foreground/60 text-wrap">
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0">
                    <Image src="/youtube-logo.svg" alt="YouTube" width={48} height={48} />
                </div>
                <div className="text-left md:text-center">
                  <div className="text-lg font-semibold text-foreground">YouTube</div>
                  <div className="text-xs text-foreground/60 text-wrap">
              ...
              {selectedPlatform === 'apple-music' && appleMusicUser && (
                <div className="text-xs text-gray-500 space-y-1">
                  ...
                  {appleMusicUser.libraryPlaylistsCount !== undefined && (
                    <div>플레이리스트: {appleMusicUser.libraryPlaylistsCount}개</div>
                  )}
                </div>
              )}
            </div>
